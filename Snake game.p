#Information on the game. This game is where if you get a point the snake grows. If you touch your tail, than the snake restarts to the original size. The point of this game is to get the most points possible.
#Backstory: This is a code that was built on pyhon. Growing up, I've played this snake game quite a lot, during classes, weekends, and freetime. I decided to bring my passion for this game to life, and make a coding project that would show my passion. This project did take a long time, and was built as a "side project". Python is the first language I learnt, and this was a way to stretch my brain and expand my thinking. This taught me a lot about variables, loops, and arrays.
